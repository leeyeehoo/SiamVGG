...
%error('Tracker not configured! Please edit the tracker_SiamVGG.m file.'); % Remove this line after proper configuration
...
tracker_command = generate_python_command('python_siamvgg', {'/home/lee/tracking/challenge/vot-toolkit/tracker/examples/python'});
